= Trade Bot https://coveralls.io/github/marcosbarbero/trade-bot?branch=master[image:https://coveralls.io/repos/github/marcosbarbero/trade-bot/badge.svg?branch=master[Coverage Status]] https://travis-ci.org/marcosbarbero/trade-bot[image:https://travis-ci.org/marcosbarbero/trade-bot.svg?branch=master[Build Status]]
 ...
 * link:https://github.com/jacoco/jacoco[Java Code Coverage - JaCoCo]
